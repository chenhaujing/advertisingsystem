...
<template>
	<div class="submitAuditBox">
		...
		<div class="submitAudit">
			<div class="auditTitle" v-text="contractData.advertisementName"></div>
			...
			<div class="buttonTools" v-if="type == 'submit'">
				<a class="buttonItem againEditButton" @click="$router.back()">
					确定
				</a>
			</div>
			<div class="buttonTools" v-if="type == 'save'">
				...
				<a class="buttonItem msgButton" @click="$router.back()">
