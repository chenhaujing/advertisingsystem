...
public class ContractForm {
    ...
    public void setStoreCount(Integer storeOfTypeA,Integer storeOfTypeB,Integer storeOfTypeC){
        this.setStoreOfTypeA(storeOfTypeA);
        this.setStoreOfTypeB(storeOfTypeB);
        this.setStoreOfTypeC(storeOfTypeC);
        this.setStoreOfAll(storeOfTypeA+storeOfTypeB+storeOfTypeC);
    }
    ...
    public void setConfigInfo(ContractAdvertisementConfig advertisementConfig) {
        this.playsize = advertisementConfig.getHorizontalResolution()+"*"+advertisementConfig.getVerticalResolution();
        this.playDuration=advertisementConfig.getDuration()+EnumUtils.toValueMap(DurationUnitEnum.class).get(advertisementConfig.getDurationUnit())+"/次";
        this.playTime=advertisementConfig.getDisplayTimes()+"次/"+ EnumUtils.toValueMap(DisplayTimeUnitEnum.class).get(advertisementConfig.getTimeUnit());
    }
    ...
    public int getSignAfterDay() {
        return signAfterDay;
    }

    public void setSignAfterDay(int signAfterDay) {
    ...
    public void setCost(double mediumCost,double productCost){
        ...
        this.setTotalCost(mediumCost+productCost);
    }
    public  void setTotalCost(){
        this.totalCost=mediumCost+productCost;
        this.setTotalCostUpper(NumberToCNUtil.number2CNMontrayUnit(new BigDecimal(this.totalCost)));
    }
